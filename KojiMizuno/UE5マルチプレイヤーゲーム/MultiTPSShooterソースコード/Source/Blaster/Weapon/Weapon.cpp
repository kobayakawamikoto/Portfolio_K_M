...
void AWeapon::BeginPlay()
{
	...
	/* // Hack the game, but Fire Delay is verified and will kick in!
	if (!HasAuthority())
	{
		FireDelay = 0.001f;
	}*/
...
void AWeapon::OnSphereOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFormSweep, const FHitResult& SweepResult)
{
...
void AWeapon::Dropped()
{
	...
	SetOwner(nullptr);
	BlasterOwnerCharacter = nullptr; // For as other player takes weapon
	BlasterOwnerController = nullptr;
}
