...
UCLASS()
class SHOOTERUE4_API AItem : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	/** Hnadle item interpolation when in the EquipInterping state */
...
private:
	...
	/** Initial Yaw offset between the cameraand the interping item */
	...
	/** Ammo for this item in the inventory */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Inventory", meta = (AllowPrivateAccess = "true"))
	UTexture2D* IconAmmo;
