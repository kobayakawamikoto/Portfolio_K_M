...
AWeapon::AWeapon() :
	...
	SlideDispacementTime(0.08f),
	bMovingSlide(false),
	MaxSlideDisplacement(7.f),
...
void AWeapon::ThrowWeapon()
{
	...
	float RandomRotation{ FMath::FRandRange(0.f, 0.f) };
...
{
	bMovingSlide = true;
	GetWorldTimerManager().SetTimer(SlideTimer, this, &AWeapon::FinishMovingSlide, SlideDispacementTime);
}
...
{
	Super::OnConstruction(Transform); // Can use AItem::OnConstruction then write this code
