...
enum class EOffsetState : uint8
{
	...
	EOS_MAX UMETA(DisplauName = "DefaultMAX")
};
 ...
 */
UCLASS()
class SHOOTERUE4_API UShooterAnimInstance : public UAnimInstance
{
	GENERATED_BODY()
public:
...
private:
	...
	/** For Inherited Shooter Character bAiming */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Movement, meta = (AllowPrivateAccess = "true"))
	bool bAiming;

	/** Yaw of the Character this frame; Only updated when standing still and not in air */
	float TIPCharacterYaw; // TIP means Turn In Place
	...
	/** Change the recoil wight based on turning in place and aiming */
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Combat", meta = (AllowPrivateAccess = "true"))
	float RecoileWeight;

	/** True when turning in place */
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Combat", meta = (AllowPrivateAccess = "true"))
	float bTurningInPlace;

	/** Weapon type for the vurrently equipped weapon */
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Combat", meta = (AllowPrivateAccess = "true"))
